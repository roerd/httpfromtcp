...
func TestRequestLineParse(t *testing.T) {
	...
	_, err = RequestFromReader(strings.NewReader("OUT_OF_ORDER /coffee HTTP/1.1\r\nHost: localhost:42069\r\nUser-Agent: curl/7.81.0\r\nAccept: */*\r\n\r\n"))
	require.Error(t, err)
	...
	// Test: Good POST Request line with path
	postRequest := "POST /coffee HTTP/1.1\r\nHost: localhost:42069\r\nUser-Agent: curl/7.81.0\r\nAccept: */*\r\n\r\n"
	reader = &chunkReader{
		data:            postRequest,
		numBytesPerRead: len(postRequest), // all at once
	}
	r, err = RequestFromReader(reader)
	require.NoError(t, err)
	require.NotNil(t, r)
...
func TestParseBody(t *testing.T) {
	...
	// Test: No Body, no reported content length
	reader = &chunkReader{
		data: "POST /submit HTTP/1.1\r\n" +
			"Host: localhost:42069\r\n" +
			"\r\n",
